              ...
              <form class="form-horizontal" action="add_barang.php" method="post">
               <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="id_brng" placeholder="id_brng">
                </div>
                <div class="form-group col-md-6">
                  <label for="">NAMA BARANG</label>
                  <input type="text" class="form-control" name="nm_brng" placeholder="nm_brng">
                </div>
                <div class="form-group col-md-6">
    ...
    while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
      ?>
                        <tr>                          
                          ...
                          <td class="td-actions">
              <a href="up_barang.php?id=<?= $d['ID_BRNG'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
              <a href="del_barang.php?id=<?= $d['ID_BRNG'] ?>" 
